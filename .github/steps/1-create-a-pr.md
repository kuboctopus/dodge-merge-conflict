...
3. my-resume をベースブランチ、main をヘッドブランチとして設定して、[プルリクエスト](https://docs.github.com/en/pull-requests/collaborating-with-pull-requests/proposing-changes-to-your-work-with-pull-requests/creating-a-pull-request)を実行してください。プルリクエストのタイトルと本文には Resolving merge conflicts と入力してください。
